...
void Producto::leerProducto(){
    cout<<"Codigo (Ejm.: PROD-001): "; fflush(stdin); getline(cin,codigoProducto);
	cout<<"Nombre: "; getline(cin,nombreProducto);
	cout<<"Categoria: "; getline(cin,categoriaProducto);
...
void Producto::modificarProducto(int n){
    switch(n){
		case 1: cout<<"Codigo (Ejm.: PROD-001): "; fflush(stdin); getline(cin,codigoProducto); cout<<"Modificacion exitosa."<<endl; break;
		case 2: cout<<"Nombre: "; fflush(stdin); getline(cin,nombreProducto); cout<<"Modificacion exitosa."<<endl; break;
		case 3: cout<<"Cantidad: "; cin>>cantidadProducto; cout<<"Modificacion exitosa."<<endl; break;
		case 4: cout<<"Categoria: "; fflush(stdin); getline(cin,categoriaProducto); cout<<"Modificacion exitosa."<<endl; break;
